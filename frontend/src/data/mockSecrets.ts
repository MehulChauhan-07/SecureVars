...
export const generateMockSecrets = (): Secret[] => [
  {
    ...
    value:
      "mongodb+srv://user:password@cluster.mongodb.net/taktix?retryWrites=true&w=majority",
    project: {
      name: "Taktix Backend",
      module: "Database",
    },
    ...
    meta: {
      description:
        "Main MongoDB Atlas connection string for production database",
      tags: ["database", "mongodb", "atlas", "production"],
      ...
      rotationReminder: {
        enabled: true,
        intervalDays: 90,
        lastRotated: new Date("2024-01-15"),
        nextDue: new Date("2024-04-15"),
      },
      personalNotes:
        "Remember to update connection string in Docker compose when rotating",
      quickCopyFormat: "env",
      usagePattern: {
        frequency: "daily",
        lastUsedInProject: "Taktix Backend",
      },
    },
  },
  {
    ...
    value:
      "super-secret-jwt-key-that-should-be-random-and-long-enough-for-security",
    project: {
      name: "Taktix Backend",
  ...
  },
  {
    ...
    value:
      '{"type":"service_account","project_id":"mobile-app-backend","private_key":"-----BEGIN PRIVATE KEY-----\\n...\\n-----END PRIVATE KEY-----\\n"}',
    project: {
